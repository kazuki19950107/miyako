<template>
  <v-form ref="equipmentDetailForm" v-model="formValid">
    ...
    <v-card outlined class="section-card">
      <v-card-title class="section-title">
        <v-icon left size="24" class="mr-2">mdi-format-list-bulleted</v-icon>
        設備リスト
      </v-card-title>
      <v-card-text class="pt-6">
        <!-- PDFダウンロードボタン -->
...
const equipmentDetailForm = ref(null)
